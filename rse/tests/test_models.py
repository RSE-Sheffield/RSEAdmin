...
class SalaryCalcultionTests(TestCase):
    ...
    def test_salary_increment_final_year(self):
        """
        Test will check the incremented salary band for a salary band
        with no data for the next year.
    ...
    def test_salary_increment_first_year(self):
        """
        Test will check the incremented salary band for a salary band
        with data available for the next financial year.
    ...
    def test_salary_increment(self):
        """
        Test will check the that a non incrementing salary band
        remains on the same grade point but uses the next financial years data.
        The correct behaviour is that the salary band should not be incremented
        but the next years financial data should be used
